...
describe("AddLiquidityForm", () => {
  it("defaults to amounts mode and explains the solved range", () => {
    ...
    fireEvent.change(screen.getByRole("spinbutton", { name: /MARKEE/ }), { target: { value: "100000" } });
    fireEvent.change(screen.getByRole("spinbutton", { name: /^ETH/ }), { target: { value: "0.08" } });
  ...
  it("offers a v2-style full-range mode that derives the pool-ratio counterpart", () => {
    ...
    expect(screen.getByText(/Spreads 8000 MARKEE \+ 0\.08 ETH across every price/)).toBeInTheDocument();
  ...
  it("switches to range mode with the solved range carried over and a derived amount", () => {
    ...
    fireEvent.change(screen.getByRole("spinbutton", { name: /MARKEE/ }), { target: { value: "1000" } });
    fireEvent.change(screen.getByRole("spinbutton", { name: /^ETH/ }), { target: { value: "0.08" } });
    ...
    fireEvent.change(screen.getByRole("spinbutton", { name: /MARKEE/ }), { target: { value: "2000" } });
