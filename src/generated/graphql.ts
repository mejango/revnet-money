...
export type ActivityEventsQuery = { activityEvents: { items: Array<{ id: string, chainId: number, timestamp: number, txHash: string, payEvent: { id: string, amount: any, beneficiary: string, memo: string | null, timestamp: number, feeFromProject: number | null, newlyIssuedTokenCount: any, from: string, txHash: string, amountUsd: any, caller: string, distributionFromProjectId: number | null, projectId: number, project: { id: string, projectId: number, handle: string | null, version: number } | null } | null, cashOutTokensEvent: { id: string, timestamp: number, txHash: string, from: string, beneficiary: string, reclaimAmount: any, cashOutCount: any, metadata: string, project: { id: string, projectId: number, handle: string | null, version: number } | null } | null, addToBalanceEvent: { txHash: string, timestamp: number, from: string, amount: any, memo: string | null } | null, mintTokensEvent: { txHash: string, timestamp: number, from: string, caller: string, beneficiary: string, beneficiaryTokenCount: any, memo: string | null } | null, manualMintTokensEvent: { txHash: string, timestamp: number, from: string, beneficiary: string, beneficiaryTokenCount: any, memo: string | null } | null, autoIssueEvent: { txHash: string, timestamp: number, from: string, beneficiary: string, count: any } | null, deployErc20Event: { txHash: string, timestamp: number, from: string, symbol: string } | null, projectCreateEvent: { txHash: string, timestamp: number, from: string } | null, projectTransferEvent: { txHash: string, timestamp: number, from: string, previousOwner: string, owner: string } | null, operatorPermissionsSetEvent: { txHash: string, timestamp: number, from: string, caller: string, operator: string, isRevnetOperator: boolean | null } | null, rulesetQueuedEvent: { txHash: string, timestamp: number, from: string, caller: string, cycleNumber: number } | null, buybackPoolEvent: { txHash: string, timestamp: number, from: string, caller: string } | null }> } };
...
export type ProjectQuery = { project: { projectId: number, metadataUri: string | null, handle: string | null, createdAt: number, suckerGroupId: string, logoUri: string | null, name: string | null, version: number, token: string | null, decimals: number | null, currency: any | null, tokenSymbol: string | null, isRevnet: boolean | null } | null };
