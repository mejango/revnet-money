...
export const metadata: Metadata = {
  ...
  description:
    "Launch and run a revnet, connect an app to one, or extend one with contracts: the wizard, the SDK, the indexer, the exact transactions, and the extension points, verified against the V6 contracts.",
};
