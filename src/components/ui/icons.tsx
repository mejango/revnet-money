...
/** Heroicons outline `question-mark-circle`. Marks an explanation of a CONCEPT — what a term
 *  means — as distinct from `InformationCircle`, which qualifies data that is already shown. */
export function QuestionMarkCircle(props: IconProps) {
  return (
    <Icon strokeWidth="1.5" {...props}>
